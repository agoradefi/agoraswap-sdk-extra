...
var BlockchainSettings = /*#__PURE__*/function () {
  ...
  _proto.setBlockchain = function setBlockchain(blockchain) {
    if (blockchain) {
      ...
      switch (this.chainId) {
        case 56:
        case 97:
          this.blockchain = exports.Blockchain.BINANCE_SMART_CHAIN;
          break;

        case 1666600000:
        case 1666700000:
          this.blockchain = exports.Blockchain.HARMONY;
          break;

        case 1088:
          this.blockchain = exports.Blockchain.METIS;
          break;

        default:
          this.blockchain = exports.Blockchain.ETHEREUM;
      }
    }
  };
  ...
  _proto.setRpcURLs = function setRpcURLs(rpcURLs) {
    if (rpcURLs && rpcURLs.length > 0) {
      ...
      switch (this.chainId) {
        ...
        case 1088:
          this.rpcURLs = ['https://andromeda.metis.io/?owner=1088'];
          break;
  ...
  _proto.setExplorerURL = function setExplorerURL(explorerURL) {
    if (explorerURL && explorerURL !== '') {
      ...
      switch (this.chainId) {
        ...
        case 1088:
          this.explorerURL = 'https://andromeda-explorer.metis.io/';
          break;
  ...
  _proto.setCurrency = function setCurrency() {
    switch (this.chainId) {
      case 56:
      case 97:
        this.currency = sdk.BINANCE_COIN;
        break;

      case 1666600000:
      case 1666700000:
        this.currency = sdk.HARMONY;
        break;

      case 1088:
        this.currency = sdk.METIS;
        break;

      default:
        this.currency = sdk.ETHER;
    }
  };
...
var BLOCKCHAIN_SETTINGS = (_BLOCKCHAIN_SETTINGS = {}, _BLOCKCHAIN_SETTINGS[sdk.ChainId.MAINNET] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.MAINNET), _BLOCKCHAIN_SETTINGS[sdk.ChainId.ROPSTEN] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.ROPSTEN), _BLOCKCHAIN_SETTINGS[sdk.ChainId.RINKEBY] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.RINKEBY), _BLOCKCHAIN_SETTINGS[sdk.ChainId.GÖRLI] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.GÖRLI), _BLOCKCHAIN_SETTINGS[sdk.ChainId.KOVAN] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.KOVAN), _BLOCKCHAIN_SETTINGS[sdk.ChainId.BSC_MAINNET] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.BSC_MAINNET), _BLOCKCHAIN_SETTINGS[sdk.ChainId.BSC_TESTNET] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.BSC_TESTNET), _BLOCKCHAIN_SETTINGS[sdk.ChainId.HARMONY_MAINNET] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.HARMONY_MAINNET), _BLOCKCHAIN_SETTINGS[sdk.ChainId.HARMONY_TESTNET] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.HARMONY_TESTNET), _BLOCKCHAIN_SETTINGS[sdk.ChainId.METIS] = /*#__PURE__*/new BlockchainSettings(sdk.ChainId.METIS), _BLOCKCHAIN_SETTINGS);
...
var Tokens = /*#__PURE__*/function () {
  ...
  _proto.convertToken = function convertToken(token) {
    return new sdk.Token(token.chainId, token.address, token.decimals, token.symbol, token.name);
  };

  return Tokens;
}();
var TOKENS = (_TOKENS = {}, _TOKENS[sdk.ChainId.MAINNET] = /*#__PURE__*/new Tokens(sdk.ChainId.MAINNET), _TOKENS[sdk.ChainId.ROPSTEN] = /*#__PURE__*/new Tokens(sdk.ChainId.ROPSTEN), _TOKENS[sdk.ChainId.RINKEBY] = /*#__PURE__*/new Tokens(sdk.ChainId.RINKEBY), _TOKENS[sdk.ChainId.GÖRLI] = /*#__PURE__*/new Tokens(sdk.ChainId.GÖRLI), _TOKENS[sdk.ChainId.KOVAN] = /*#__PURE__*/new Tokens(sdk.ChainId.KOVAN), _TOKENS[sdk.ChainId.BSC_MAINNET] = /*#__PURE__*/new Tokens(sdk.ChainId.BSC_MAINNET), _TOKENS[sdk.ChainId.BSC_TESTNET] = /*#__PURE__*/new Tokens(sdk.ChainId.BSC_TESTNET), _TOKENS[sdk.ChainId.HARMONY_MAINNET] = /*#__PURE__*/new Tokens(sdk.ChainId.HARMONY_MAINNET), _TOKENS[sdk.ChainId.HARMONY_TESTNET] = /*#__PURE__*/new Tokens(sdk.ChainId.HARMONY_TESTNET), _TOKENS[sdk.ChainId.METIS] = /*#__PURE__*/new Tokens(sdk.ChainId.METIS), _TOKENS);

exports.BLOCKCHAIN_SETTINGS = BLOCKCHAIN_SETTINGS;
exports.BlockchainSettings = BlockchainSettings;
exports.TOKENS = TOKENS;
exports.Tokens = Tokens;
//# sourceMappingURL=sdk-extra.cjs.development.js.map
