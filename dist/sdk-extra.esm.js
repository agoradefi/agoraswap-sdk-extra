  ...
  _proto.setBlockchain = function setBlockchain(blockchain) {
    if (blockchain) {
      ...
      switch (this.chainId) {
        ...
        case 1088:
          this.blockchain = Blockchain.METIS;
          break;
